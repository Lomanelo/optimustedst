...
export const extractedContent: CMSContent[] = [
  ...
  },
  {
    ...
    section: CMS_SECTIONS.HERO,
    content_en: 'MBA . DBA',
    content_ar: 'ماجستير إدارة الأعمال • دكتوراه إدارة الأعمال',
  ...
  },
  {
    ...
    section: CMS_SECTIONS.GENERAL,
    content_en: 'Doctor of Business Administration (DBA)',
    content_ar: 'دكتوراه في إدارة الأعمال (DBA)',
    description: 'DBA option in certificate selection',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  {
  ...
  },
  {
    ...
    section: CMS_SECTIONS.PROGRAMS_OVERVIEW,
    content_en: 'Explore DBA Programs',
    content_ar: 'استكشف برامج دكتوراه إدارة الأعمال',
    description: 'Link text to explore DBA programs',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  ...
  },
  {
    ...
    content_ar: 'التميز في البحث',
    description: 'DBA program research feature',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  {
    ...
    description: 'DBA program academic feature',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  {
    ...
    description: 'DBA program supervision feature',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  {
    ...
    content_ar: 'برامج دكتوراه إدارة الأعمال للتميز الأكاديمي والمهني في مجالات الدراسة المتخصصة',
    description: 'DBA program description',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
  {
  ...
  },
  {
    ...
    section: CMS_SECTIONS.PROGRAMS,
    content_en: 'DBA',
    content_ar: 'دكتوراه إدارة الأعمال',
    description: 'DBA program type filter option',
    lastUpdated: new Date().toISOString(),
    updatedBy: 'system'
  },
